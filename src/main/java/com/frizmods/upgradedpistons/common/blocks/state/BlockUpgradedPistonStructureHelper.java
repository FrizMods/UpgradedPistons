package com.frizmods.upgradedpistons.common.blocks.state;
...
public class BlockUpgradedPistonStructureHelper
{
    ...
    public boolean canMove()
    {
        ...
        if (!BlockUpgradedPistonBase.canPush(iblockstate, this.world, this.blockToMove, this.moveDirection, false, this.moveDirection))
        {
    ...
    private boolean addBlockLine(BlockPos origin, EnumFacing p_177251_2_)
    {
        ...
        else if (!BlockUpgradedPistonBase.canPush(iblockstate, this.world, origin, this.moveDirection, false, p_177251_2_))
        {
            return true;
        }
        ...
        else
        {
            ...
            else
            {
                while (block.isStickyBlock(iblockstate))
                {
                    ...
                    if (iblockstate.getBlock().isAir(iblockstate, this.world, blockpos) || !BlockUpgradedPistonBase.canPush(iblockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos))
                    {
                        break;
                    }
                ...
                while (true)
                {
                    ...
                    if (!BlockUpgradedPistonBase.canPush(iblockstate, this.world, blockpos1, this.moveDirection, true, this.moveDirection) || blockpos1.equals(this.pistonPos))
                    {
                        return false;
                    }
